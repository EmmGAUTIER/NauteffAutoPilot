##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.9.0-B19] date: [Sat Jun 13 16:56:36 CEST 2026] 
##########################################################################################################################
...
Core/Src/syscalls.c \
AP/aux/src/rlib.c \
AP/aux/src/rbuffer.c \
AP/aux/src/printf.c \
AP/tasks/src/mems.c \
AP/tasks/src/service.c \
AP/tasks/src/apmain.c \
...
#AP/compute/src/madgwickAHRS.c \#AP/compute/src/madgwickAHRS.c \#AP/compute/src/kalmanAHRS.c \
...
CFLAGS += $(C_VER) $(MCU) $(C_DEFS) $(C_INCLUDES) $(OPT) -Wall -fdata-sections -ffunction-sections
