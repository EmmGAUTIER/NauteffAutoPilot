...
__attribute__ ((interrupt("irq"))) void DMA1_stream1 (void);
__attribute__ ((interrupt("irq"))) void DMA1_stream2 (void);

void I2C_init ();
void I2C_start_periph (I2C_Handle*);
void I2C1_set_std_speed (I2C_Handle*);
void I2C1_enable (I2C_Handle*);
